<?php
namespace pragmatic\mcp\services;
...
class ToolService extends Component
{
    ...
    private function searchEntries(array $args): array
    {
        ...
        return array_map(function($entry) {
            return PragmaticMcp::getInstance()->resourceService->formatEntry($entry);
        }, $entries);
    }
    ...
    private function getEntryDetails(array $args): array
    {
        ...
        $data = PragmaticMcp::getInstance()->resourceService->formatEntry($entry);
